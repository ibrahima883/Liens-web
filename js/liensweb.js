...
ajouterLienBtn.addEventListener("click", function (e) {
    ...
    var ajouterBtn = document.createElement("button"); // button ou input
    ...
    ajouterBtn.addEventListener("click", function (e) { 
        ...
        // Si l'un des champs de saisie (tous obligatoires) n'a pas été renseigné, l'ajout
        // du lien est annulé et on indique à l'utilisateur qu'il doit le renseigner
        if ( (auteur === "") || (titre === "") || (url === "") ) {
            
            // Gestionnaire de validation de l'ajout
            formElt.addEventListener("submit", function () {}); // "submit" ou "input"
            
        } else { // Tous les champs de saisie ont été renseignés
